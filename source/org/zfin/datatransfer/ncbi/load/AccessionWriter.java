...
public class AccessionWriter {
    ...
    public NCBIOutputFileToLoad buildLoadRecords() {
        ...
        writeMatchedGenes(matches.getConfirmed(), PUB_MAPPED_BASED_ON_RNA, recordsToLoad, lengths);
        writeMatchedGenes(matches.getSupplement(), PUB_MAPPED_BASED_ON_NCBI_SUPPLEMENT, recordsToLoad, lengths);
        writeMatchedGenes(matches.getLegacyVega(), PUB_MAPPED_BASED_ON_VEGA, recordsToLoad, lengths);
    ...
    private void writeMatchedGenes(BidiMap<String, String> matchMap, String pub,
        ...
        for (Map.Entry<String, String> entry : matchMap.entrySet()) {
            ...
            writeDownstreamAccessions(zfinGene, ncbiGene, pub, records, lengths);
        }
    }
    ...
    private void writeDownstreamAccessions(String zfinGene, String ncbiGene, String pub,
        ...
        for (Object[] row : rows) {
            ...
            // GenBank RNA (non-RefSeq RNA accessions)
            if (rnaAcc != null && !isRefSeq(rnaAcc)) {
