...
BEGIN
    ...
    if (table_prefix not like '%_fast_search_old_%'
        ...
        and table_prefix not like 'phenotype_generated_curated_mapping_old_%') then
        return 'this function should only be used to clean up tables named like ..._fast_search_old_..., all_term_contains_old_..., or phenotype_*_old_...';
    end if;
