...
export default [
    {
        ...
        adapter: {
            ...
            rootUrlTemplate: {
                ...
                uri: "https://s3.amazonaws.com/agrjbrowse/docker/7.1.0/zfin/zebrafish-11/tracks/All_Genes/{refseq}/trackData.jsonz",
            },
        },
        displays: [
            {
                type: "LinearBasicDisplay",
                displayId: "GRCz11_all_genes-LinearBasicDisplay",
                renderer: {
                    maxHeight: 5000,
            ...
            },
            {
                ...
                displayId: "GRCz11_all_genes-LinearArcDisplay",
            },
        ],
    },
    {
        ...
        formatDetails: {
            feature:
                "jexl:{id:null,curie:null,ZFIN:'<a href=\"http://zfin.org/'+feature.id+' \">'+feature.name+'</a>'}",
        },
        category: ["ZFIN tracks"],
        adapter: {
            type: "NCListAdapter",
            rootUrlTemplate: {
                locationType: "UriLocation",
    ...
    },
    {
        ...
        formatDetails: {
            feature:
                "jexl:{ ZFIN: '<a href=\"http://zfin.org/'+feature.id+' \">'+feature.name+'</a>'}",
        },
        displays: [
            {
                type: "LinearBasicDisplay",
    ...
    },
    {
        ...
        formatDetails: {
            feature:
                "jexl:{ ZFIN: '<a href=\"http://zfin.org/'+feature.gene_id+' \">'+feature.name+'</a>'}",
        },
        adapter: {
            type: "NCListAdapter",
            rootUrlTemplate: {
    ...
    },
    {
        ...
        displays: [
            ...
            },
            {
                type: "LinearArcDisplay",
                displayId:
                    "zfin_genes_with_antibody_data-1687908124039-LinearArcDisplay",
            },
        ],
    },
    {
        ...
        displays: [
            {
                type: "LinearBasicDisplay",
                displayId:
                    "zfin_genes_with_expression-1687908166699-LinearBasicDisplay",
            },
            {
                type: "LinearArcDisplay",
    ...
    },
    {
        ...
        formatDetails: {
            feature:
                "jexl:{ ZFIN: '<a href=\"http://zfin.org/'+feature.zdb_id+' \">'+feature.name+'</a>'}",
        },
        adapter: {
            type: "NCListAdapter",
            rootUrlTemplate: {
        ...
        displays: [
            {
                type: "LinearBasicDisplay",
                displayId:
                    "zebrafish_mutation_project-1687908719190-LinearBasicDisplay",
                renderer: {
                    type: "SvgFeatureRenderer",
                    color1: "#800080",
                },
    ...
    },
    {
        ...
        adapter: {
            ...
            vcfGzLocation: {
                locationType: "UriLocation",
                uri: "https://s3.amazonaws.com/agrjbrowse/VCF/7.1.0/zebrafish-latest.vcf.gz",
            },
            index: {
                location: {
                    locationType: "UriLocation",
                    uri: "https://s3.amazonaws.com/agrjbrowse/VCF/7.1.0/zebrafish-latest.vcf.gz.tbi",
                },
            },
        },
        displays: [
            {
                ...
                displayId: "GRCz11_variants-LinearVariantDisplay",
            },
            {
                type: "ChordVariantDisplay",
                displayId: "GRCz11_variants-ChordVariantDisplay",
            },
        ],
    },
    {
        type: "VariantTrack",
        trackId: "GRCz11_ht_variants",
        ...
        adapter: {
            ...
            vcfGzLocation: {
                locationType: "UriLocation",
                uri: "https://s3.amazonaws.com/agrjbrowse/VCF/7.1.0/HTPOSTVEPVCF_ZFIN_latest.vcf.gz",
            },
            index: {
                location: {
                    locationType: "UriLocation",
                    uri: "https://s3.amazonaws.com/agrjbrowse/VCF/7.1.0/HTPOSTVEPVCF_ZFIN_latest.vcf.gz.tbi",
                },
            },
        },
        displays: [
            {
                ...
                type: "LinearVariantDisplay",
                displayId: "GRCz11_ht_variants-LinearVariantDisplay",
            },
            {
                type: "ChordVariantDisplay",
                displayId: "GRCz11_ht_variants-ChordVariantDisplay",
            },
        ],
    },
];
