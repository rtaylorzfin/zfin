<VirtualHost *:80>
    ...
    DocumentRoot	/srv/www/macdev/home
    ...
    ScriptAlias	/cgi-bin /srv/www/macdev/cgi-bin
    ...
    Include /srv/www/macdev/server_apps/apache/inc-redirect

    ProxyRequests Off
    ProxyPreserveHost On
    ProxyPass /action/ http://host.docker.internal:2008/action/
    ProxyPassReverse /action/ http://host.docker.internal:2008/action/
    #ProxyPass /blast/ http://genomix.cs.uoregon.edu/cgi-bin/zfin/
    #ProxyPassReverse /blast/ http://genomix.cs.uoregon.edu/cgi-bin/zfin/
    ProxyPass /ajax/ http://host.docker.internal:2008/ajax/
    ProxyPassReverse /ajax/ http://host.docker.internal:2008/ajax/ 
    ...
    ProxyPass /webapp/ http://host.docker.internal:2008/webapp/
    ProxyPassReverse /webapp/ http://host.docker.internal:2008/webapp/
    ProxyPass /webservice/ http://host.docker.internal:2008/webservice/
    ProxyPassReverse /webservice/ http://host.docker.internal:2008/webservice/
...
<VirtualHost *:443>
    ...
    ProxyPass /action/ https://host.docker.internal:8443/action/
    ProxyPassReverse /action/ https://host.docker.internal:8443/action/
    ProxyPass /ajax/ https://host.docker.internal:8443/ajax/
    ProxyPassReverse /ajax/ https://host.docker.internal:8443/ajax/ 
    ProxyPass /webapp/ https://host.docker.internal:8443/webapp/
    ProxyPassReverse /webapp/ https://host.docker.internal:8443/webapp/
    ProxyPass /webservice/ https://host.docker.internal:8443/webservice/
    ProxyPassReverse /webservice/ https://host.docker.internal:8443/webservice/
