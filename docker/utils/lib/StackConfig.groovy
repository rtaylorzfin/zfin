...
class StackConfig {
    ...
    // docker-compose.review-member.yml.
    //
    ...
    static Map<String, String> featureEnv(String host) {
        [ DOCKER_EXTERNAL_VHOST: '',     // present but EMPTY: invisible to any external
          ...
          DOCKER_REVIEW_VHOST  : host,   // the review proxy routes this hostname
