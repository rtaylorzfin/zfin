...
class QuerySpec extends ZfinIntegrationSpec {
    ...
    public static Logger logger = LogManager.getLogger(QuerySpec.class)
    ...
    def "a query for '#queryString' in '#category' should find some records according to case #fogbugzCase"() {
        ...
        Category.GENE.name                       | "gsc misexpression id:ZDB-GENE-990415-8"                                         | "12776"
        Category.GENE.name                       | "ZFIN:ZDB-GENE-990415-8 id:ZDB-GENE-990415-8"                                    | "INF-2933"
        Category.EXPRESSIONS.name                | "la116Tg Schaefer conditions:\"cancer xenotransplantation\""                     | "SRCH-1065"
        ...
        Category.PHENOTYPE.name                  | "y1Tg Baltrunaite conditions:\"cancer xenotransplantation\""                     | "SRCH-1065"
