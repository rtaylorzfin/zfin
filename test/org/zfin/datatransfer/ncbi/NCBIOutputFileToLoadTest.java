...
public class NCBIOutputFileToLoadTest {
    ...
    @Test
    public void testAssemblyIdsAreWrittenCommaJoined() throws IOException {
        NCBIOutputFileToLoad fileOutput = new NCBIOutputFileToLoad();
        fileOutput.addRow(new NCBIOutputFileToLoad.LoadFileRow(
                "ZDB-GENE-000112-47", "NM_001001398", 1234, FDCONT_REFSEQ_RNA, PUB_MAPPED_BASED_ON_RNA, Set.of(1L, 2L)));

        String expectedOutput = "ZDB-GENE-000112-47|NM_001001398||1234|ZDB-FDBCONT-040412-38|ZDB-PUB-020723-3|1,2\n";
        assertEquals(expectedOutput, fileOutput.getOutput());
    }
